...
image:https://javadoc.io/badge2/io.github.m-m-m/mmm-ui-api-controller/javadoc.svg["JavaDoc",link=https://javadoc.io/doc/io.github.m-m-m/mmm-ui-api-controller]
