...
/**
 * {@link UiDynamicComposite} for a {@link #getName() named} sub-group in a {@link UiFormPanel form} of {@link UiInput}s as
 * {@link #getChild(int) children} shown vertically from the top to the bottom.
 *
