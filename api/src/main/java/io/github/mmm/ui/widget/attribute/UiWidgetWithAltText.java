...
/**
 * {@link UiWidget} that has an {@link #getAltText() alternative text}.
 *
 * @since 1.0.0
 */
public interface UiWidgetWithAltText extends UiWidget {

  /**
   * @return the <em>alternative text</em> of this widget. This text is used to provide the essential information of an
