...
/**
 * Interface to read and write min/max ranges for the {@link #setPosition(double, double) position}.
 *
 * @since 1.0.0
 */
public interface AttributeWritePositionRange extends AttributeWritePosition {
   ...
   *         and is automatically clipped to the available width (of the {@link io.github.mmm.ui.UiScreen} or
   *         {@link io.github.mmm.ui.widget.window.UiMainWindow}). Should be greater or equal to {@link #getMinX()
   *         minX}.
   */
  double getMaxX();
   ...
   *         and is automatically clipped to the available width (of the {@link io.github.mmm.ui.UiScreen} or
   *         {@link io.github.mmm.ui.widget.window.UiMainWindow}). Should be greater or equal to {@link #getMinY()
   *         minY}.
   */
  double getMaxY();
