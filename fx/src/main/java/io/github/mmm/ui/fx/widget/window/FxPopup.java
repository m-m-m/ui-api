...
public class FxPopup extends FxAbstractWindow<Stage> implements UiPopup {
  ...
  public FxPopup(UiContext context) {
    ...
    this.nativeWidget.initModality(Modality.APPLICATION_MODAL);
    this.buttonPanel = new FxButtonPanel(context);
    this.composite.getChildren().add(this.buttonPanel.getNativeWidget());
  }
  ...
  protected void setEnabledNative(boolean enabled) {
    ...
    this.buttonPanel.setEnabled(enabled, UiFlagMode.PARENT);
  }
