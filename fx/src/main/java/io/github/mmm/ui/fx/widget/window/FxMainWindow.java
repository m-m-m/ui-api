...
public class FxMainWindow extends FxAbstractWindow<Stage> implements UiMainWindow {
   ...
   * @param nativeWidget the {@link #getNativeWidget() JavaFx widget} (primary stage).
   */
  public FxMainWindow(UiContext context, Stage nativeWidget) {
  ...
  public UiMenuBar getMenuBar() {
    ...
    if (this.menuBar == null) {
      ...
      this.composite.getChildren().add(0, this.menuBar.getNativeWidget());
    }
    return this.menuBar;
  }
