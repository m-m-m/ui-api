 ...
 * <b>ATTENTION:</b><br>
 * A {@link UiMenuBar} should only be accessed via {@link io.github.mmm.ui.widget.window.UiMainWindow#getMenuBar()}.
 * Never manually create {@link UiMenuBar} via {@link io.github.mmm.ui.UiContext#create(Class)}. This is only possible
 * for modularity of the UI implementations and direct creation outside {@link io.github.mmm.ui.UiContext} is
