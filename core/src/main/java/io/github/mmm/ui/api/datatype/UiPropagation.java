 ...
 * {@link io.github.mmm.ui.api.widget.composite.UiComposite} will propagate to its children.
 *
...
public enum UiPropagation {
  ...
  /** Only {@link io.github.mmm.ui.api.widget.UiWidget#isVisible() visible} property is propagated. */
  VISIBLE,

  /** Only {@link io.github.mmm.ui.api.widget.UiWidget#isEnabled() enabled} property is propagated. */
  ENABLED,

  /**
   * Both {@link io.github.mmm.ui.api.widget.UiWidget#isVisible() visible} and
   * {@link io.github.mmm.ui.api.widget.UiWidget#isEnabled() enabled} are propagated.
   */
  VISIBLE_AND_ENABLED;
