...
import io.github.mmm.ui.api.datatype.bitmask.InverseBitMask;

/**
 * {@link BitMask} constants for {@link io.github.mmm.ui.api.widget.UiWidget#setEnabled(boolean, BitMask)}.
 *
 * @since 1.0.0
 */
public interface UiEnabledFlags {
  ...
  /**
   * {@link InverseBitMask} reserved for the {@link io.github.mmm.ui.api.widget.UiWidget#getParent() parent}. E.g. a virtual
   * {@link io.github.mmm.ui.api.widget.composite.UiComposite} may change its
   * {@link io.github.mmm.ui.api.widget.UiWidget#setVisible(boolean) visibility} by
   * {@link io.github.mmm.ui.api.widget.UiWidget#setVisible(boolean, BitMask) changing the visibility using this mask} for
   * of all its {@link io.github.mmm.ui.api.widget.composite.UiComposite#getChild(int) children}.
   */
  InverseBitMask PARENT = InverseBitFlag.B01;

  /**
   * {@link InverseBitMask} reserved for {@link io.github.mmm.ui.api.widget.UiWidget#setReadOnly(boolean) read-only} e.g. if
   * {@link io.github.mmm.ui.api.widget.input.UiInput input widgets} do not support read-only natively.
   */
  InverseBitMask READ_ONLY = InverseBitFlag.B02;

  /**
   * {@link InverseBitMask} reserved for authorization. Applications typically disable
   * {@link io.github.mmm.ui.api.widget.UiWidget widgets} (typically buttons), if the user does not have permissions to
