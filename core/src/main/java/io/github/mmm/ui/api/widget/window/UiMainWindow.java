 ...
 * {@link io.github.mmm.ui.api.UiContext#getMainWindow()}. Never manually create {@link UiMainWindow} via
 * {@link io.github.mmm.ui.api.UiContext#create(Class)}. This is only possible for modularity of the UI implementations and
 * direct creation outside {@link io.github.mmm.ui.api.UiContext} is unspecified and behavior can change in future versions.
 *
 *
 * @see io.github.mmm.ui.api.UiContext#getMainWindow()
 *
 * @since 1.0.0
 */
