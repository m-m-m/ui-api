 ...
 * implementations for all supported toolkits (technically via {@link io.github.mmm.ui.api.factory.UiWidgetFactoryNative}).
 ...
 * <br>
 * For advanced usage see also {@link io.github.mmm.ui.api.widget.custom.UiCustomWidget}.
 *
 * @since 1.0.0
 */
public interface UiWidget extends EventSource<UiEvent, UiEventListener>, AttributeReadValid, AttributeWriteId {
   ...
   * A {@link io.github.mmm.ui.api.widget.composite.UiComposite} will propagate the read-only state to all its children when
   ...
   * {@link io.github.mmm.ui.api.widget.composite.UiComposite} it will set the focus to the first child capable of taking
   * the focus.<br>
   * <b>NOTE:</b><br>
   ...
   * {@link io.github.mmm.ui.api.widget.composite.UiComposite#getChild(int) children} and propagation to {@link #getParent()
   * parent}s). This will update the {@link #isValid() valid state} and
   * {@link io.github.mmm.ui.api.widget.value.UiValidatableWidget#getValidationFailure() failure message} of all involved
   ...
   *         widget and all its potential {@link io.github.mmm.ui.api.widget.composite.UiComposite#getChild(int) children}
   ...
   * {@link io.github.mmm.ui.api.widget.composite.UiTab}s and other composites that can collapse or hide their children to
   ...
   *         {@link io.github.mmm.ui.api.widget.value.UiValuedWidget#setValue(Object) set programmatically}, {@code false}
   *         otherwise. A modified widget is also called <em>dirty</em>. A {@link UiComposite} is modified if one of its
   *         {@link io.github.mmm.ui.api.widget.composite.UiComposite#getChild(int) children} are modified. An immutable
   ...
   *         {@link io.github.mmm.ui.api.widget.value.UiValidatableWidget#getOriginalValue() original value} it may still
