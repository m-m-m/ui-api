...
For motivation and details see the https://github.com/m-m-m/ui-api/wiki[wiki] or https://m-m-m.github.io/docs/api/io.github.mmm.ui.api.core/module-summary.html[JavaDoc].
