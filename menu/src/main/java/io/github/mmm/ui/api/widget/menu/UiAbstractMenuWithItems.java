 ...
 *
 * @see #addItem(String, UiEventListener, int)
...
public interface UiAbstractMenuWithItems extends UiAbstractMenu<UiAbstractMenuEntry> {
   ...
   */
  default UiMenuItem addItem(String text, UiEventListener listener) {
   ...
   * @return the created and added {@link UiMenuItem}.
   */
  UiMenuItem addItem(String text, UiEventListener listener, int index);
